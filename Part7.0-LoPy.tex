...
Le programme \lprog{BME280.py} peut fonctionner comme un module mais la dernière partie donne un exemple d'exploiation des résultats~:
...
Le programme \lprog{wifi\_temperature.py} montre cette adaptation.
...
{Que se passe-t-il si dans le programme \lprog{wifi\_temperature.py} vous modifiez le pas de mesure ligne 36, pour le mettre par exemple à 60 secondes.}
{
